...
| Crisis lock | withdrawals blocked while ADL is pending or termination is scheduled |
...
| ADL execution | `executeAdl(winners[], priceUpdate)` | 0.1% of averted bad debt | `isAdlPending`; rank winners by score, descending |
